...
var app = express();
const mongostring =`mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@mangesh-ux.sv1di.mongodb.net/accounts-app?retryWrites=true&w=majority`
// Connect to db
// --------------------------------------------------
MongoClient.connect(mongostring, (err, client) => {
  ...
  const db = client.db('accounts-app');
